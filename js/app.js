(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                new core(".swiper-company", {
                    ...
                    navigation: {
                        prevEl: ".btn-nav-company-left",
                        nextEl: ".btn-nav-company-right"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 30,
                ...
                new core(".swiper-our-lawyers", {
                    ...
                    speed: 800,
                    pagination: {
                        el: ".swiper-pagination-our-lawyers",
                        clickable: true
                    },
                    navigation: {
                        prevEl: ".btn-nav-our-lawyers-left",
                        nextEl: ".btn-nav-our-lawyers-right"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 24,
                ...
                new core(".other-post-swiper", {
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".other-post-prev",
                        nextEl: ".other-post-next"
                    },
                    breakpoints: {
                        280: {
                            slidesPerView: 1
        ...
        function addClassToPreviousBlock(event) {
            ...
            if (previousBlock) previousBlock.classList.add("active");
        }
        function removeClassFromPreviousBlock(event) {
            const currentBlock = event.currentTarget;
            const previousBlock = currentBlock.previousElementSibling;
            if (previousBlock) previousBlock.classList.remove("active");
        }
        ...
        btnPractices.forEach(((btnPractice, index) => {
            if (window.innerWidth < 550.98) btnPractice.addEventListener("click", (function(e) {
                btnPractice.classList.toggle("active");
                const textPractice = textPractices[index];
        ...
        if (document.getElementById("history-tabs")) {
            var tabButtonWrappers = document.querySelectorAll(".history-slide");
            var tabContents = document.querySelectorAll(".history__content");
            tabButtonWrappers.forEach((function(wrapper, index) {
                wrapper.addEventListener("click", (function() {
                    for (var i = 0; i < tabContents.length; i++) tabContents[i].style.display = "none";
                    tabContents[index].style.display = "block";
                    tabButtonWrappers.forEach((function(wrapper) {
                        wrapper.querySelector(".history-btn-tab ").classList.remove("active-tab-btn");
                    }));
                    wrapper.querySelector(".history-btn-tab ").classList.add("active-tab-btn");
                }));
            }));
